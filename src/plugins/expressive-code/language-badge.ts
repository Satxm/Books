...
export function pluginLanguageBadge() {
	return definePlugin({
      ...
      [data-language]::before {
        ...
        font-family: "Inconsolata", "LXGW WenKai Screen", "JetBrains Mono Variable", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
        font-size: 0.75rem;
        font-weight: bold;
